...
class Campaign(object):
	def __init__(self, average_users, attr_gender=None, attr_income=None,attr_age=None):
		self.average_users = average_users
		self.attr_gender = attr_gender
		self.attr_age = attr_age
		self.attr_income = attr_income
		self.count_attrs = sum([1 for x in [attr_gender, attr_age, attr_income] if x is not None ])
		self.length = None
		self.budget = None
		self.reach = None
		self.start_day = None
		...
		assert self.attr_age is not None or self.attr_gender is not None or self.attr_income is not None
	...
	def matches_user(self, user):
		if  (self.attr_gender is None or self.attr_gender == user.attr_gender) and \
		  (self.attr_income is None or self.attr_income == user.attr_income) and \
		  (self.attr_age is None or self.attr_age == user.attr_age):
			return True
		else:
			return False
...
campaigns.append(Campaign(average_users = 808, attr_gender="Male", attr_age="Old", attr_income="High"))
campaigns.append(Campaign(average_users = 1795, attr_gender="Male", attr_age="Old", attr_income="Low"))
campaigns.append(Campaign(average_users = 517, attr_gender="Male", attr_age="Young", attr_income="High"))
campaigns.append(Campaign(average_users = 1836, attr_gender="Male", attr_age="Young", attr_income="Low"))
campaigns.append(Campaign(average_users = 407, attr_gender="Female", attr_age="Old", attr_income="High"))
campaigns.append(Campaign(average_users = 2401, attr_gender="Female", attr_age="Old", attr_income="Low"))
campaigns.append(Campaign(average_users = 256, attr_gender="Female", attr_age="Young", attr_income="High"))
campaigns.append(Campaign(average_users = 1980, attr_gender="Female", attr_age="Young", attr_income="Low"))
